...
public class FileUploadHandler {
    ...
    @Autowired
    public FileUploadHandler(@Qualifier("s3ServiceImpl") IStorageService storageService, @Value("${storage.bucket:mycommerce-roboticsmind-prod-media}") String bucketName) {
